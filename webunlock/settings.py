"""
Django settings for webunlock project.
...
SECRET_KEY = 'django-insecure-sct5%pys!-+huo*afrmw&2wdai%sca*bevdq%#_q$*k(xs5a6g'
...
# Database
# https://docs.djangoproject.com/en/4.2/refsettings/#databases
